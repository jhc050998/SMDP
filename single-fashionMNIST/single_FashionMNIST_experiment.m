...
train_pattern = 10 * train_pattern;    % 原始数据为[0，2.9], 乘以10
test_pattern = 10 * test_pattern;
...
nargin = 0 ;         
threshold = 1;  
tau_m = 8;          tau_s = tau_m/4;          beta = tau_m/tau_s;
...
for learnRate = 1: length(learnRate_w_o) 
    ...
    save FashionMNIST_single_0005 maxTrain maxTest  max_w_o -mat
    end   
