...
clear 
close all
load('./encoded_bupa.mat')
samples = round(encoded_bupa);
...
T = 120;         dt = 1;          Timeline = dt: dt: T; % T=110
Ni = 150;     Nh = 360;    No = 2;           Nclass = No;% 231-iono,80-pima,150-bupa,135-wbc,160-iris 
learnRate_w_o =[.008];  %-bupa-T=110 [.008 .01 .007 .0005 ]
...
for learnRate = 1: length(learnRate_w_o) % 循环学习�?
    ...
    save puba_result maxTrain maxTest max_w_h max_w_o -mat
end
