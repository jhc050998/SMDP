...
Ni = 231;      No = 2;         Nclass = No;% 231-iono,80-pima,150-bupa,135-wbc,160-iris 
learnRate_w_o = [.01] ;  % [.01 .008 .005 .001 .1]
% learnRate_w_o = [.001 .0005 .0001 .00005] ;
...
for learnRate = 1: length(learnRate_w_o) % 循环学习�?
    ...
    save single_iono_result maxTrain maxTest  max_w_o -mat
end
toc;
